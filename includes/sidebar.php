    ...
    <aside id="left-panel" class="left-panel stylenav">
        ...
        <nav class="nav_style navbar navbar-expand-sm  navbar-fixed-left">

            <div class="navbar-header">
                <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#main-menu" aria-controls="main-menu" aria-expanded="false" aria-label="Toggle navigation">
                    <i class="fa fa-bars"></i>
                </button> 
                <a href="dashboard.php"><img src="images/oss_logo.png" alt="LOGO" height="50px" width="70px">  </a>
                <a class="navbar-brand" href="dashboard.php">OLD STAREHIAN SOCIETY | </a>
